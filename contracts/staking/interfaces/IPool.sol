...
interface IPool {
    ...
    function extendLockPeriod(uint256 _depositId, uint256 _newLockUntil) external;

    function shortenLockPeriod(uint256 _depositId, uint256 _newLockUntil) external;
}
